...
namespace WalkaChomika
{
    ...
    sealed partial class App : Application
    {
        ...
        /// first line of authored code executed, and as such is the
        /// logical equivalent of main() or WinMain().
        /// </summary>
        public App()
        {
        ...
        /// end user. Other entry points will be used such as when the
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (e.PrelaunchActivated == false)
            {
                if (rootFrame.Content == null)
                {
                    ...
                    // navigate to the first page, configuring the new
                    // page by passing required information as a
        ...
        /// application will be terminated or resumed with the contents
